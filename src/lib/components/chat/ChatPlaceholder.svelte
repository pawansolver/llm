<script lang="ts">
	...
	import { config, user, models as _models, temporaryChatEnabled, WEBUI_NAME } from '$lib/stores';
...
{#key mounted}
	<div class="m-auto w-full max-w-[58rem] px-8 lg:px-20">
					...
					>
						...
						>
							<img
								...
								class=" size-[2.7rem] rounded-full object-cover"
								alt="{$WEBUI_NAME}"
								draggable="false"
							/>
						</Tooltip>
		...
		<!-- Banner Image -->
		<div class="w-full mb-4 mt-6 flex justify-start" in:fade={{ duration: 200 }}>
			<img
				src="/static/favicon.png"
				class="h-32 md:h-40 object-contain rounded-xl"
				alt="{$WEBUI_NAME} logo"
				draggable="false"
			/>
		</div>
