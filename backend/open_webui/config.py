...
AUDIO_STT_MAX_UPLOAD_SIZE_MB = max(1, int(os.getenv('AUDIO_STT_MAX_UPLOAD_SIZE_MB', '20')))
AUDIO_STT_MAX_CONCURRENT_REQUESTS = max(1, int(os.getenv('AUDIO_STT_MAX_CONCURRENT_REQUESTS', '2')))
AUDIO_STT_TIMEOUT_SECONDS = max(1, int(os.getenv('AUDIO_STT_TIMEOUT_SECONDS', '300')))
AUDIO_STT_MODEL_LOAD_TIMEOUT_SECONDS = max(1, int(os.getenv('AUDIO_STT_MODEL_LOAD_TIMEOUT_SECONDS', '600')))
AUDIO_STT_RATE_LIMIT = max(0, int(os.getenv('AUDIO_STT_RATE_LIMIT', '20')))
AUDIO_STT_RATE_LIMIT_WINDOW_SECONDS = max(1, int(os.getenv('AUDIO_STT_RATE_LIMIT_WINDOW_SECONDS', '60')))
AUDIO_STT_RETENTION_SECONDS = max(0, int(os.getenv('AUDIO_STT_RETENTION_SECONDS', '0')))
AUDIO_SPEECH_CACHE_TTL_SECONDS = max(0, int(os.getenv('AUDIO_SPEECH_CACHE_TTL_SECONDS', '86400')))
AUDIO_SPEECH_CACHE_MAX_ENTRIES = max(0, int(os.getenv('AUDIO_SPEECH_CACHE_MAX_ENTRIES', '1000')))
...
DEFAULT_CONFIG = {
    ...
    'audio.stt.max_upload_size_mb': AUDIO_STT_MAX_UPLOAD_SIZE_MB,
    'audio.stt.max_concurrent_requests': AUDIO_STT_MAX_CONCURRENT_REQUESTS,
    'audio.stt.timeout_seconds': AUDIO_STT_TIMEOUT_SECONDS,
    'audio.stt.rate_limit': AUDIO_STT_RATE_LIMIT,
    'audio.stt.rate_limit_window_seconds': AUDIO_STT_RATE_LIMIT_WINDOW_SECONDS,
    'audio.stt.retention_seconds': AUDIO_STT_RETENTION_SECONDS,
    ...
    'audio.tts.cache_ttl_seconds': AUDIO_SPEECH_CACHE_TTL_SECONDS,
    'audio.tts.cache_max_entries': AUDIO_SPEECH_CACHE_MAX_ENTRIES,
    'webui.url': WEBUI_URL,
